...
function handleSlide(e) {
	...
	if(["KeyA", "KeyD", "KeyW", "KeyS"].includes(e.code)){
		...
		if (e.code == "KeyA" && canMoveLeft()) {
            slideLeft();
            setTwo();
        } else if (e.code == "KeyD" && canMoveRight()) {
            slideRight();
            setTwo();
        } else if (e.code == "KeyW" && canMoveUp()) {
            slideUp();
            setTwo();
        } else if (e.code == "KeyS" && canMoveDown()) {
            slideDown();
            setTwo();
        }
	}
	...
	if(hasLost()){
		setTimeout(() => {
			alert("YOU ARE FINISHED! NO MORE MOVES MWAHAHAHAHA!");
			restartGame();
